              ...
              if (typeof value === "string" && value.startsWith("data:image")) {
                return (
                  ...
                  >
                    ...
                    <dd className="text-sm text-gray-900 font-medium sm:w-2/3">
                      <img
                        src={value}
                        alt="Profile"
                  ...
                  <div className="flex-shrink-0 flex justify-center md:justify-start">
                    <div className="relative">
                      <img
                        ...
                        alt="Profile"
                        className="w-32 h-32 rounded-2xl object-cover border-4 border-primary-100 shadow-sm"
                      />
                    </div>
                  </div>
                )}
                ...
                <dl className="space-y-4">
                  {Object.entries({
                    ...
                    return (
                      <div
                        key={key}
                        className="flex flex-col sm:flex-row  sm:items-center gap-2 sm:gap-4 py-2 px-4 border-b border-gray-50 last:border-0"
                      >
                        <dt className="text-sm font-semibold text-gray-500 capitalize sm:w-1/3">
                          {key.replace(/([A-Z])/g, " $1").trim()}
                        </dt>
                        <dd className="text-sm text-gray-900 font-medium sm:w-2/3 bg-gray-50 py-2 px-2 rounded-lg break-words">
                          {value.toString()}
                        </dd>
                      </div>
                    );
